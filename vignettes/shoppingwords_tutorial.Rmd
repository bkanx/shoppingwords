...
cleaned_reviews |>    
  ...
  summarise(avg_text_length =

    mean(nchar(cleaned_text)))  
...
reviews_test |> 
    ...
    scale_fill_manual(values = c("p" = "lightblue", "n" = "darkred"),
...
Wickham, H. (2016). ggplot2: Elegant Graphics for Data Analysis. Springer-Verlag New York, isbn = 978-3-319-24277-4, available at URL: https://ggplot2.tidyverse.org
